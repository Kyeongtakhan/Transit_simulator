...
/*
  This is a Constructor that initiates the ConfigManager object.
*/
ConfigManager::ConfigManager() : routes_(std::vector<Route *>()) {
}
/*
  This is a Destructor that destructs the routes and elements in the vector
*/
...
/*
  ...
  ReadConfig function will automatically change last stop probability to zero
*/
