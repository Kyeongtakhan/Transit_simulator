...
/*
  Sets up the member variable of CaptureSimulator class that will be used in Capture Local simulator such as Stops, Routes, Generator
*/
bool CaptureLocalSimulator::Start() {
  ...
  out_ << "         STARTING" << std::endl;
  out_ << "        SIMULATION" << std::endl;
  out_ << "*************************/" << std::endl;
...
/*
 Iterates fixed set of rounds with the simulation_time_elapsed_.
...
*/
bool CaptureLocalSimulator::Update() {
  // increase time
