...
int RtestPassengerGenerator::GeneratePassengers() {
  ...
  (*stop_iter)->GetId() < last_stop_index; stop_iter++) {
    ...
    /*
     When the RtestPassengerGenerator is being used in the route and called in the route for passenger generating,
     the new passenger will be generated by the DeterministicPassengerFactory for deterministic passenger generating.
    */
    Passenger * tmp = DeterministicPassengerFactory::
